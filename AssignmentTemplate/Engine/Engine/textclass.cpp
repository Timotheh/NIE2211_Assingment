...
bool TextClass::Render(ID3D11DeviceContext* deviceContext, FontShaderClass* FontShader, const XMMATRIX& worldMatrix, const XMMATRIX& orthoMatrix)
{
	bool result;
...
bool TextClass::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, FontShaderClass* FontShader, const XMMATRIX& worldMatrix,
