...
bool WaterShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
	const XMMATRIX& projectionMatrix, const XMMATRIX& reflectionMatrix, ID3D11ShaderResourceView* refractionTexture,
...
bool WaterShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix,
	const XMMATRIX& reflectionMatrix, ID3D11ShaderResourceView* refractionTexture,
										   ...
										   XMFLOAT4 refractionTint, XMFLOAT3 lightDirection, float specularShininess)
{
	...
	dataPtr->reflection = XMMatrixTranspose(reflectionMatrix);
	/*
